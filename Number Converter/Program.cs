...
Console.WriteLine("5: Decimal(multiply by 9) to Binary");
Console.WriteLine("6: Test for Hexadecimal to Decimal");
    ...
    case 5:
        {
            ...
            {
                curr5 = gavraNum % 2;
                answerNum += curr5 * (int)Math.Pow(10, i5);
                gavraNum /= 2;
                i5++;
            }
            Console.WriteLine($"gavra: {answerNum}");
            break;
        }
    case 6:
        {
            string hexInput = Console.ReadLine();
            int decimalNumber = Convert.ToInt64(hexInput, 16);
